...
export function DashboardPricing() {
    ...
    const handlePlanSelection = (planTitle: string) => {
        ...
        alert(`You selected the ${planTitle} plan. Payment integration coming soon.`);
    };

    return (
        <section className="relative py-12 overflow-hidden rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                {/* Header */}
                <div className="text-center mb-12 space-y-4">
                    <h2 className="text-3xl md:text-4xl font-medium text-white tracking-tight font-sans">
                        Upgrade Your Plan
                    </h2>
